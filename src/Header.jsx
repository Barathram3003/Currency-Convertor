    ...
    return (
        <header className='bg-white top-0 flex items-center justify-between px-12 rounded-2xl md:px-20 py-6'>
            <a href="https://barathram3003.github.io/Portfolio---Barathramana-C-/" className='cursor-pointer'>
                <p className='lg:font-extrabold lg:text-3xl font-semibold text-2xl font-play'>Barathramana</p>
            </a>
            ...
            <div className="relative" ref={dropdownRef}>
                ...
                {isOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-gradient-to-r bg-white shadow-lg z-50 rounded-2xl">
                        <a
                            href="https://weatherapp-br03.netlify.app/"
                            className="block px-4 py-2 font-semibold bg-purple-400 hover:bg-blue-950 text-white"
                        >
                            Weather App
                        </a>
                        <a
